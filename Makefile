...
# so that disk image changes after first build are persistent until clean.  
# More details: http://www.gnu.org/software/make/manual/html_node/Chained-Rules.html
